          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                                ...
                                return AlertDialog(
                                  ...
                                  children: [
                                    ...
                                    CircleAvatar(
                                        ...
                                        child: widget.profile_user.fileType! ==
                                                '1'
                                            ? CircleAvatar(
                                                radius: 50,
                                                backgroundImage:
                ...
                Container(
                  padding:
                      EdgeInsets.only(left: 30, top: 20, bottom: 8, right: 30),
                  height: 120,
                  width: width,
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        ...
                        children: [
                          ...
                          GestureDetector(
                            ...
                            child: Row(
                              children: [
                                Text(
                                  (widget.profile_user.clzClubs!['head']
                                              .length +
                                          widget.profile_user
                        ...
                        children: [
                          ...
                          GestureDetector(
                            ...
                            child: Row(
                              children: [
                                Text(
                                  (widget.profile_user.clzSports!['head']
                                              .length +
                                          widget.profile_user
                        ...
                        children: [
                          ...
                          GestureDetector(
                            ...
                            child: Row(
                              children: [
                                Text(
                                  (widget.profile_user.clzFests!['head']
                                              .length +
                                          widget.profile_user
                ...
                club_sport_fest_sac[0]
                    ? clzCSFS(
                        widget.app_user, widget.profile_user, 'club', [], [])
                    : club_sport_fest_sac[1]
                        ? clzCSFS(widget.app_user, widget.profile_user, 'sport',
                            [], [])
                        : club_sport_fest_sac[2]
