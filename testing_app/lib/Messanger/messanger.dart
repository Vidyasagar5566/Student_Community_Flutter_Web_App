                      ...
                      IconButton(
                        onPressed: () {
                          Navigator.of(context).push(MaterialPageRoute(
                            ...
                            return search_bar(widget.app_user,
                                domains[widget.app_user.domain]!);
                          }));
                        },
                        icon:
                            const Icon(Icons.person_search_outlined, size: 25),
                      ),
                    ]),
                  )
                ],
                          ...
                          child: Column(
                            children: [
                              ...
                              widget.user_conversation.isEmpty && total_loaded
                                  ...
                                  : ListView.builder(
                                      itemCount:
                                          widget.user_conversation.length,
                                      shrinkWrap: true,
                                      padding: EdgeInsets.zero,
                                      physics: NeverScrollableScrollPhysics(),
                                      itemBuilder:
                                                                    ...
                                                                    ? GestureDetector(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child: Container(
                                                                              height: width * (0.7),
                                                                              width: width,
                                                                              decoration: BoxDecoration(borderRadius: BorderRadius.circular(8), image: const DecorationImage(image: AssetImage("images/Explorer.png"), fit: BoxFit.cover))),
                                                                        ))
                                                                    : Container())
                                                    : Container(),
